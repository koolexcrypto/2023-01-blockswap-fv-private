...
/**
* accumulatedETHPerFreeFloatingShare should be updated when ETH accrued per shares
*/
rule updateAccumulatedETHPerFreeFloatingShare()
{
    ...
    assert accumulatedETHPerFreeFloatingShareAfter == accumulatedETHPerFreeFloatingShare + NewAccumulatedETH, "";
